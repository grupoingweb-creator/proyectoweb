...
import { User, Edit, Trash2, Search, X } from "lucide-react";
...
function Usuarios() {
  ...
  const cargarUsuarios = async () => {
    try {
      const res = await axios.get("http://localhost:4000/api/usuario/usuarios");
      if (res.data.ok) {
  ...
  const handleEliminar = async (id) => {
    ...
    try {
      await axios.delete(`https://proyectoweb-knts.onrender.com`);
